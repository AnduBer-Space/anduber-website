...
/**
 * Newsletter teaser. Honest perspectives from the AnduBer collective —
 * intentionally framed as the organisation's voice, not a personal column.
 */
      ...
      <Container className="relative z-10">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-full
                           border-2 text-token-primary
                           border-plum-300 dark:border-cream-200/40
                           transition-all duration-300
                           hover:border-gold-500 dark:hover:border-gold-400
                           hover:text-token-gold"
              >
                Browse the blog
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="rounded-3xl border border-token-glass bg-token-secondary backdrop-blur-sm p-8 md:p-10 shadow-2xl">
              <div className="flex items-center gap-3 mb-6">
                <div
                  ...
                  aria-hidden="true"
                />
                <span className="text-xs uppercase tracking-[0.18em] text-token-gold font-semibold">
                  Latest Edition
                </span>
              </div>
              <h3 className="font-serif text-xl md:text-2xl text-token-primary leading-snug mb-4">
                &ldquo;If we&rsquo;re still measuring boreholes drilled, we&rsquo;ve already lost.&rdquo;
              </h3>
              <p className="text-sm text-token-secondary leading-relaxed mb-6">
              ...
              <div className="flex items-center justify-between text-xs text-token-muted">
                ...
                <span>Field notes · AnduBer collective</span>
              </div>
            </div>
            <div
              aria-hidden="true"
