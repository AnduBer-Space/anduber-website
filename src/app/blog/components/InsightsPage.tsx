        ...
        <Container className="relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gold-400/10 border border-gold-400/30 text-gold-700 dark:text-gold-400 text-sm font-medium mb-6"
            >
          ...
          <div className="max-w-2xl mx-auto">
            ...
            >
              ...
              <div className="w-20 h-20 mx-auto mb-8 rounded-2xl bg-gold-400/20 flex items-center justify-center">
                <Lightbulb className="w-10 h-10 text-gold-700 dark:text-gold-400" />
              </div>

              <h2 className="font-serif text-2xl md:text-3xl font-bold text-plum-900 dark:text-cream-200 mb-4">
                Subscribe to the Newsletter
              </h2>

              <p className="text-plum-600 dark:text-cream-300 mb-8 leading-relaxed">
