      ...
      <Container className="relative z-10">
        ...
        >
          <motion.span
            ...
            className="inline-block text-teal-600 dark:text-teal-400 text-sm uppercase tracking-[0.2em] mb-4"
          >
            Build With Us
          </motion.span>
          ...
          <motion.h1
            ...
            className="text-4xl md:text-5xl lg:text-6xl font-serif text-plum-900 dark:text-cream-200 mb-6"
          >
            Join the{" "}
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-plum-600 dark:text-cream-300 max-w-3xl mx-auto leading-relaxed"
          >
          ...
          <motion.div
            ...
            className="mt-8 flex flex-wrap justify-center gap-4 text-sm text-plum-600/70 dark:text-cream-300/70"
          >
