...
export default function JoinFooterQuote() {
  return (
    <section className="relative py-24 overflow-hidden">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-t from-cream-100 to-cream-50 dark:from-plum-800 dark:to-plum-900" />
      ...
      <Container className="relative z-10">
        ...
        >
          <Quote className="w-12 h-12 text-gold-700/50 dark:text-gold-400/50 mx-auto mb-8" />

          <blockquote className="text-xl md:text-2xl lg:text-3xl font-serif text-plum-900 dark:text-cream-200 leading-relaxed mb-8">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <span className="text-plum-600 dark:text-cream-300 text-sm uppercase tracking-wider">AnduBer</span>
